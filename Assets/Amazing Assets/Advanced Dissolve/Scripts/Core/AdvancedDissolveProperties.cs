    ...
    public static class AdvancedDissolveProperties
    {
        ...
        public class Cutout
        {
            ...
            public class Standard
            {
                ...
                static IDs[] ids = {new IDs(0), new IDs(1), new IDs(2), new IDs(3), new IDs(4)};
            ...
            public class Geometric
            {
                ...
                public static class UpdateLocalProperty
                {
                    ...
                    public static void Capsule(Material material, AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 startPosition, Vector3 endPosition, float radius)
                    {
                        ...
                        {
                            case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                                UpdateLocal(material, Property.Position1, startPosition);
                                UpdateLocal(material, Property.Normal1, normal);
                                UpdateLocal(material, Property.Radius1, radius);
                                UpdateLocal(material, Property.Height1, height);
                                break;

                            case AdvancedDissolveKeywords.CutoutGeometricCount.Two:
                                UpdateLocal(material, Property.Position2, startPosition);
                                UpdateLocal(material, Property.Normal2, normal);
                                UpdateLocal(material, Property.Radius2, radius);
                                UpdateLocal(material, Property.Height2, height);
                                break;

                            case AdvancedDissolveKeywords.CutoutGeometricCount.Three:
                                UpdateLocal(material, Property.Position3, startPosition);
                                UpdateLocal(material, Property.Normal3, normal);
                                UpdateLocal(material, Property.Radius3, radius);
                                UpdateLocal(material, Property.Height3, height);
                                break;

                            case AdvancedDissolveKeywords.CutoutGeometricCount.Four:
                                UpdateLocal(material, Property.Position4, startPosition);
                                UpdateLocal(material, Property.Normal4, normal);
                                UpdateLocal(material, Property.Radius4, radius);
                                UpdateLocal(material, Property.Height4, height);
                                break;
                        }
                    }
                ...
                public static class UpdateGlobalProperty
                {
                    ...
                    public static void Capsule(AdvancedDissolveKeywords.GlobalControlID globalControlID, AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 startPosition, Vector3 endPosition, float radius)
                    {
                        ...
                        {
                            case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                                UpdateGlobal(globalControlID, Property.Position1, startPosition);
                                UpdateGlobal(globalControlID, Property.Normal1, normal);
                                UpdateGlobal(globalControlID, Property.Radius1, radius);
                                UpdateGlobal(globalControlID, Property.Height1, height);
                                break;

                            case AdvancedDissolveKeywords.CutoutGeometricCount.Two:
                                UpdateGlobal(globalControlID, Property.Position2, startPosition);
                                UpdateGlobal(globalControlID, Property.Normal2, normal);
                                UpdateGlobal(globalControlID, Property.Radius2, radius);
                                UpdateGlobal(globalControlID, Property.Height2, height);
                                break;

                            case AdvancedDissolveKeywords.CutoutGeometricCount.Three:
                                UpdateGlobal(globalControlID, Property.Position3, startPosition);
                                UpdateGlobal(globalControlID, Property.Normal3, normal);
                                UpdateGlobal(globalControlID, Property.Radius3, radius);
                                UpdateGlobal(globalControlID, Property.Height3, height);
                                break;

                            case AdvancedDissolveKeywords.CutoutGeometricCount.Four:
                                UpdateGlobal(globalControlID, Property.Position4, startPosition);
                                UpdateGlobal(globalControlID, Property.Normal4, normal);
                                UpdateGlobal(globalControlID, Property.Radius4, radius);
                                UpdateGlobal(globalControlID, Property.Height4, height);
                                break;
                        }
                    }
        ...
        public class Edge
        {
            ...
            public class Base
            {
                ...
                [Range(0, 1)]
                public float widthCutoutStandard = 0.1f;

                [Range(0, 1)]
                public float widthCutoutGeometric = 0.1f;
                ...
                [Range(0, 1)]
                public float colorTransparency = 1;
