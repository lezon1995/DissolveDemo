...
namespace AmazingAssets.AdvancedDissolve
{
    ...
    public class AdvancedDissolveGeometricCutoutController : AdvancedDissolveController
    {
        ...
        {
#if UNITY_EDITOR
            Undo.RecordObject(this, "Reset Geometric Cutout Controller");
#endif
            ...
            target1StartPointTransform = null;
            target1EndPointTransform = null;
            target1StartPointPosition = Vector3.zero;
            target1EndPointPosition = Vector3.zero;
            target1Radius = 0;
            target1Normal = Vector3.up;
            target1Rotation = Vector3.zero;
            target1Size = Vector3.one;

            target2StartPointTransform = null;
            target2EndPointTransform = null;
            target2StartPointPosition = Vector3.zero;
            target2EndPointPosition = Vector3.zero;
            target2Radius = 0;
            target2Normal = Vector3.up;
            target2Rotation = Vector3.zero;
            target2Size = Vector3.one;

            target3StartPointTransform = null;
            target3EndPointTransform = null;
            target3StartPointPosition = Vector3.zero;
            target3EndPointPosition = Vector3.zero;
            target3Radius = 0;
            target3Normal = Vector3.up;
            target3Rotation = Vector3.zero;
            target3Size = Vector3.one;

            target4StartPointTransform = null;
            target4EndPointTransform = null;
            target4StartPointPosition = Vector3.zero;
            target4EndPointPosition = Vector3.zero;
            target4Radius = 0;
        ...
        public float GetTargetRadius(AdvancedDissolveKeywords.CutoutGeometricCount countID)
        {
            switch (countID)
            {
                case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                    if (target1Radius < 0) target1Radius = 0;
                    return target1Radius;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Two:
                    if (target2Radius < 0) target2Radius = 0;
                    return target2Radius;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Three:
                    if (target3Radius < 0) target3Radius = 0;
                    return target3Radius;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Four:
                    if (target4Radius < 0) target4Radius = 0;
                    return target4Radius;
            }
        ...
        public void SetTargetStartPointTransform(AdvancedDissolveKeywords.CutoutGeometricCount countID, Transform transform)
        {
            ...
            {
                case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                    target1StartPointTransform = transform;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Two:
                    target2StartPointTransform = transform;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Three:
                    target3StartPointTransform = transform;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Four:
                    target4StartPointTransform = transform;
                    break;
            }
        }
        ...
        public void SetTargetEndPointTransform(AdvancedDissolveKeywords.CutoutGeometricCount countID, Transform transform)
        {
            ...
            {
                case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                    target1EndPointTransform = transform;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Two:
                    target2EndPointTransform = transform;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Three:
                    target3EndPointTransform = transform;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Four:
                    target4EndPointTransform = transform;
                    break;
            }
        }
        ...
        public void SetTargetStartPointPosition(AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 position)
        {
            ...
            {
                case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                    target1StartPointPosition = position;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Two:
                    target2StartPointPosition = position;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Three:
                    target3StartPointPosition = position;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Four:
                    target4StartPointPosition = position;
                    break;
            }
        }
        ...
        public void SetTargetEndPointPosition(AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 position)
        {
            ...
            {
                case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                    target1EndPointPosition = position;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Two:
                    target2EndPointPosition = position;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Three:
                    target3EndPointPosition = position;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Four:
                    target4EndPointPosition = position;
                    break;
            }
        }
        ...
        public void SetTargetRadius(AdvancedDissolveKeywords.CutoutGeometricCount countID, float radius)
        {
            ...
            {
                case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                    target1Radius = radius;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Two:
                    target2Radius = radius;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Three:
                    target3Radius = radius;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Four:
                    target4Radius = radius;
                    break;
            }
        }
        ...
        public void SetTargetNormal(AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 normal)
        {
            ...
            {
                case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                    target1Normal = normal;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Two:
                    target2Normal = normal;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Three:
                    target3Normal = normal;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Four:
                    target4Normal = normal;
                    break;
            }
        }
        ...
        public void SetTargetRotation(AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 rotation)
        {
            ...
            {
                case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                    target1Rotation = rotation;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Two:
                    target2Rotation = rotation;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Three:
                    target3Rotation = rotation;
                    break;
                case AdvancedDissolveKeywords.CutoutGeometricCount.Four:
                    target4Rotation = rotation;
                    break;
            }
        }
