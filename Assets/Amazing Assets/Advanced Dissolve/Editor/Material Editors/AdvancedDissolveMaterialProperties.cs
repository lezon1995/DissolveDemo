...
namespace AmazingAssets.AdvancedDissolveEditor
{
    ...
    public static class AdvancedDissolveMaterialProperties
    {
        public static string prefName_DissolvePropertiesFoldout = "AD_EditorPrefName_DissolvePropertiesFoldout";
        public static string prefName_UnityPropertiesFoldout = "AD_EditorPrefName_UnityPropertiesFoldout";
        public static string prefName_UnityFooterFoldout = "AD_EditorPrefName_UnityFooterFoldout";
        public static string prefName_CurvedWorldFoldout = "AD_EditorPrefName_CurvedWorldFoldout";
        ...
        public static bool foldoutDissolveProperties = true;
        public static bool foldoutUnityProperties = true;
        public static bool foldoutUnityFooterProperties;
        public static bool foldoutCurvedWrold;
        ...
        public static void Init(MaterialProperty[] props)
        {
            //Cutout
        ...
        public static MaterialProperty FindProperty(string propertyName, MaterialProperty[] properties, bool mandatory = true)
        {
        ...
        public static void DrawDissolveOptions(bool drawHeader, UnityEditor.MaterialEditor m_MaterialEditor, bool drawUserDefinedCutout, bool drawUserDefinedEdgeColor, bool drawUVDistortion, bool drawGI, bool canBakeKeywords)
        {
        ...
        public static bool DrawDefaultOptionsHeader(string title, Material material)
        {
            return DrawHeader(title, ref foldoutUnityProperties, prefName_UnityPropertiesFoldout, material);
        }
        public static bool DrawFooterOptionsHeader()
        {
            return DrawHeader("Additional Rendering Options", ref foldoutUnityFooterProperties, prefName_UnityFooterFoldout, null);
        }
        public static void DrawCurvedWorldHeader(bool drawHeader, GUIStyle guiStyle, UnityEditor.MaterialEditor materialEditor, Material material)
        {
        ...
        public static void DrawGroupHeader(string label)
        {
        ...
        public static void DrawBlendModePopup(UnityEditor.MaterialEditor m_MaterialEditor, MaterialProperty _Mode)
        {
