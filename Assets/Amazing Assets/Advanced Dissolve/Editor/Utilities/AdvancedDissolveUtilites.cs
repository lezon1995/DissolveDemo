...
namespace AmazingAssets.AdvancedDissolveEditor
{
    public static class Utilities
    {
        ...
        public static string GetPathToTheAssetInstallationtFolder()
        {
        ...
        public static void StringToKeywords(string label,
        ...
        public static string KeywordsToString(Material material)
        {
        ...
        public static bool IsShaderAdvancedDissolve(Shader shader, out bool isBaked)
        {
        ...
        public static void CreategeometricCutoutControllerscripWithObjects(Material material, AdvancedDissolve.AdvancedDissolveKeywords.GlobalControlID globalControlID, AdvancedDissolve.AdvancedDissolveKeywords.CutoutGeometricType cutoutGeometricType, AdvancedDissolve.AdvancedDissolveKeywords.CutoutGeometricCount cutoutGeometricCount)
        {
        ...
        public static GameObject CreateGeometricCutoutTargetObject(Transform parent, string name, Vector3 position, Quaternion rotation, Vector3 scale, bool registerUndo)
        {
